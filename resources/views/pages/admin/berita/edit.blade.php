                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="Ringkasan" class="form-control" rows="3"
                                    placeholder="Tulis ringkasan singkat berita (1-2 kalimat)...">{{ old('Ringkasan', $berita->Ringkasan) }}</textarea>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="card card-outline card-warning">
                        ...
                        <div class="card-body">
                            ...
                            <div class="alert alert-light border mb-3">
                                ...
                                <div style="font-family: arial, sans-serif;">
                                    <div id="seoPreviewTitle"
                                        ...
                                        {{ old('SEOTitle', $berita->SEOTitle ?: $berita->Judul) }}
                                    </div>
                                    ...
                                    <div id="seoPreviewDesc" style="color: #545454; font-size: 13px; line-height: 1.4;">
                                        {{ old('SEODescription', $berita->SEODescription ?: 'Deskripsi berita akan muncul di sini...') }}
                                    </div>
                                </div>
                            </div>
                            ...
                            <!-- SEO Title -->
                            <div class="form-group">
                                @php $seoTitleVal = old('SEOTitle', $berita->SEOTitle); @endphp
                            ...
                            <!-- SEO Description -->
                            <div class="form-group">
                                @php $seoDescVal = old('SEODescription', $berita->SEODescription); @endphp
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="SEOKeywords" class="form-control"
                                    value="{{ old('SEOKeywords', $berita->SEOKeywords) }}"
