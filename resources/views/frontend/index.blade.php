        ...
        <div class="swiper th-slider hero-slider-1" id="heroSlide1"
                ...
                <div class="swiper-slide">
                    <div class="hero-inner">
                        <div class="th-hero-bg"
                            data-bg-src="{{ asset('') }}assets-landing-page/img/hero/hero_bg_1_1.jpg">
                        </div>
                        <div class="hero-1-shape d-none d-lg-block" data-ani="slideinleft" data-ani-delay="0.4s">
                            <img src="{{ asset('') }}assets-landing-page/img/shape/hero-1-shape.png"
                                alt="hero-shape">
                        </div>
                        <div class="container">
                            <div class="row">
            ...
            <div class="th-swiper-custom">
                <button data-slider-prev="#heroSlide1" class="slider-arrow slider-prev"><img
                        src="{{ asset('') }}assets-landing-page/img/icon/right-arrow.svg"
                        alt=""></button>
            ...
            <div class="feature-area overflow-hidden " id="feature-area">
                <div class="row gx-0 justify-content-center">
                    <div class="col-xl-4 col-lg-6">
                        <div class="feature-item d-flex align-items-start">
                            <div class="feature-item_icon">
                                <img src="{{ asset('') }}assets-landing-page/img/icon/feature_1_1.svg"
                                    alt="icon">
                            </div>
                            <div class="media-body">
                    ...
                    <div class="col-xl-4 col-lg-6">
                        <div class="feature-item d-flex align-items-start">
                            <div class="feature-item_icon">
                                <img src="{{ asset('') }}assets-landing-page/img/icon/feature_1_2.svg"
                                    alt="icon">
                            </div>
                            <div class="media-body">
        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-6">
                    <div class="img-box1">
                        <div class="img1">
                            <img src="{{ asset('') }}assets-landing-page/img/normal/about_1_1.jpg"
                                alt="About">
                        </div>
                        <div class="img2">
                            <img src="{{ asset('') }}assets-landing-page/img/normal/about_1_2.jpg"
                                alt="About">
                        </div>
                        <div class="img3">
                            <img src="{{ asset('') }}assets-landing-page/img/normal/about_1_3.jpg"
                                alt="About">
                        </div>
                    </div>
                </div>
                        ...
                        <div class="about-item-wrap">
                            <div class="about-item wow fadeInUp" data-wow-delay=".2s">
                                <div class="about-item_img"><img
                                        src="{{ asset('') }}assets-landing-page/img/icon/map3.svg"
                                        alt=""></div>
                            ...
                            <div class="about-item wow fadeInUp" data-wow-delay=".3s">
                                <div class="about-item_img"><img
                                        src="{{ asset('') }}assets-landing-page/img/icon/guide.svg"
                                        alt=""></div>
                                <div class="about-item_centent">
