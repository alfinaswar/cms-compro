    ...
    <section class="content">
        <div class="row justify-content-center">
            <div class="col-xl-12 col-lg-12">
                <form action="{{ route('roles.update', $role->id) }}" method="POST" id="formRoleEdit">
                    @csrf
                    @method('PUT')
                            ...
                            <div class="form-group mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="name" id="name"
                                        ...
                                        placeholder="Contoh: Admin, Staff, Manager" value="{{ old('name', $role->name) }}"
                                        autofocus>
                                </div>
                                @error('name')
...
@push('scripts')
    <script>
        $(document).ready(function() {
            ...
            // Auto uncheck "select all" if any checkbox is unchecked
