                ...
                <div class="card shadow-sm">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="module" id="module" class="form-control form-control @error('module') is-invalid @enderror" required>
                        ...
                        <div class="form-group">
                            ...
                            <small class="text-muted">Kosongkan jika menggunakan pilihan di atas. Format: <code>modul.aksi</code></small>
                        </div>
