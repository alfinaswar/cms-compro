...
@section('content')
    ...
    <section class="content">
        ...
        <form id="formUserEdit" action="{{ route('users.update', $user->id) }}" method="POST">
            @csrf
            @method('PUT')
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Edit Akun / Pengguna Sistem</h3>
                        </div>
                        <div class="card-body">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="password" name="password" id="password"
                                            ...
                                            placeholder="Isi jika ingin mengubah password" minlength="12"
                        ...
                        <div class="card-footer d-flex justify-content-end">
                            <button type="submit" form="formUserEdit" class="btn btn-primary">
